...
The Rectangle class provides methods to calculate the area and perimeter of a rectangle,
as well as comparison of rectangles based on their areas.
...
Classes:
    Rectangle: Represents a rectangle shape and provides methods to operate on rectangles.
"""
